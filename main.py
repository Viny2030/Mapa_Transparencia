...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header { background: linear-gradient(135deg, var(--azul) 0%, #005bb5 100%); color: white; padding: 2rem 1.5rem 1.5rem; text-align: center; }
  header h1 { font-size: 1.9rem; font-weight: 700; letter-spacing: -0.5px; }
  header p  { font-size: 0.95rem; opacity: 0.85; margin-top: 0.4rem; }
  .badge { display: inline-block; background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.3); border-radius: 20px; padding: 0.2rem 0.8rem; font-size: 0.78rem; margin-top: 0.6rem; }
  nav { background: var(--azul); display: flex; justify-content: center; gap: 0.5rem; padding: 0.6rem 1rem; flex-wrap: wrap; }
  nav a { color: rgba(255,255,255,0.8); text-decoration: none; font-size: 0.82rem; padding: 0.3rem 0.7rem; border-radius: 4px; transition: background 0.2s; }
  ...
  .poderes { max-width: 1100px; margin: 2.5rem auto; padding: 0 1rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; }
  .poder { background: white; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.07); overflow: hidden; }
  .poder-header { padding: 1rem 1.2rem; display: flex; align-items: center; gap: 0.7rem; }
  ...
  .monitor-item { display: flex; align-items: center; gap: 0.8rem; padding: 0.75rem 0.8rem; border-radius: 8px; text-decoration: none; color: var(--texto); transition: background 0.18s; border-bottom: 1px solid #f0f0f0; }
  ...
  .mi-status { font-size: 0.7rem; padding: 0.15rem 0.5rem; border-radius: 10px; font-weight: 600; }
  ...
  .stats { max-width: 900px; margin: 0 auto 2rem; padding: 0 1rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 1rem; }
  .stat-card { background: white; border-radius: 10px; padding: 1rem; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
  ...
  footer { text-align: center; padding: 1.5rem; font-size: 0.8rem; color: #888; border-top: 1px solid #e0e0e0; background: white; }
...
<div class="poderes">
  ...
  <div class="poder poder-ejecutivo" id="ejecutivo">
    <div class="poder-header">
      ...
      <div><h3>Poder Ejecutivo Nacional</h3><p>JGM · SGP · Presidencia · Contratos</p></div>
    </div>
    <div class="monitor-list">
      <a class="monitor-item" href="https://jefaturagabinete-production.up.railway.app" target="_blank" rel="noopener">
        ...
        <div class="mi-info"><div class="mi-title">Monitor Ejecutivo</div><div class="mi-desc">JGM · SGP · Presidencia · Contratos · Nómina · Alertas</div></div>
      ...
      <a class="monitor-item" href="https://gobbocomprartgn-production.up.railway.app" target="_blank" rel="noopener">
        <span class="mi-icon">⚖️</span>
        <div class="mi-info"><div class="mi-title">Monitor de Contratos v1</div><div class="mi-desc">COMPR.AR · TGN · Análisis de riesgo en tiempo real</div></div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
      <a class="monitor-item" href="https://monitorcontratosv2-production-65d2.up.railway.app" target="_blank" rel="noopener">
        <span class="mi-icon">📊</span>
        <div class="mi-info"><div class="mi-title">Monitor de Contratos v2</div><div class="mi-desc">BORA + COMPR.AR · Detección de irregularidades XAI</div></div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
    </div>
  </div>
  ...
  <div class="poder poder-legislativo" id="legislativo">
    <div class="poder-header">
      ...
      <div><h3>Poder Legislativo Nacional</h3><p>Cámara de Diputados · Senado</p></div>
    </div>
    <div class="monitor-list">
      <a class="monitor-item" href="https://monitorlegistativo-production.up.railway.app" target="_blank" rel="noopener">
        <span class="mi-icon">🗳️</span>
        <div class="mi-info"><div class="mi-title">Monitor Legislativo · Diputados</div><div class="mi-desc">ICE · Asistencia · Productividad · Costo per cápita</div></div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
      <a class="monitor-item" href="https://monitorlegistativosenadores-production.up.railway.app" target="_blank" rel="noopener">
        <span class="mi-icon">🏅</span>
        <div class="mi-info"><div class="mi-title">Monitor Legislativo · Senadores</div><div class="mi-desc">Participación · Reporte por partido · Indicadores</div></div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
    </div>
  </div>
  ...
  <div class="poder poder-judicial" id="judicial">
    <div class="poder-header">
      <span class="icon">⚖️</span>
      <div><h3>Poder Judicial de la Nación</h3><p>CSJN · Magistratura · Juzgados federales</p></div>
    </div>
    <div class="monitor-list">
      <a class="monitor-item" href="https://justicia-production-6a54.up.railway.app" target="_blank" rel="noopener">
        <span class="mi-icon">⚖️</span>
        <div class="mi-info"><div class="mi-title">Monitor Judicial</div><div class="mi-desc">Corte Suprema · Magistratura · Cámaras · Juzgados · IRA</div></div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
    </div>
  </div>
  ...
  <div class="poder poder-iri" id="iri" style="grid-column: 1 / -1;">
    <div class="poder-header">
      <span class="icon">🚦</span>
      <div><h3>Índice de Riesgo Institucional (IRI)</h3><p>Semáforo de integridad pública · Score compuesto</p></div>
    </div>
    <div class="monitor-list">
      <a class="monitor-item" href="https://monitor-production-f053.up.railway.app" target="_blank" rel="noopener">
        ...
        <div class="mi-info">
          ...
          <div class="mi-desc">Score compuesto: R_Financiero×35% + R_Contratación×30% + R_Operativo×20% + R_Datos×15%</div>
        </div>
        <span class="mi-status status-live">EN VIVO</span>
      </a>
    </div>
...
<div style="max-width:1100px; margin: 0 auto 2rem; padding: 0 1rem;">
  <div style="background:#fff8e1; border-left:4px solid #f39c12; border-radius:6px; padding:1rem 1.2rem; font-size:0.82rem; color:#555; line-height:1.6;">
    ⚠️ <strong>Aviso:</strong> Herramienta experimental y académica. Datos de fuentes públicas oficiales.
    Indicadores algorítmicos de riesgo — no implican acusación ni responsabilidad sobre ninguna empresa, organismo o persona.
  </div>
</div>
